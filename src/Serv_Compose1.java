...
String replyto=req.getParameter("from");
...
//if(Mto!=null)
//{  
   sos.println("To                  :<input type=text name=to value= '"+replyto+"'><br>");   
   sos.println("Subject             :<input type=text name=subject value='"+subject+"'><br>");

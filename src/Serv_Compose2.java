...
//	Serv_SignUp ss=(Serv_SignUp)scon.getServlet("Serv_SignUp");
	...
	flname=session.getValue("filename").toString();
...
//{  
   ...
   sos.println("<table><tr><td><a href=Upload.html><font face=verdana><h5>Attach Files</h5></font></a></td><td><input type=text name=file value="+flname+"/></td></tr></table>");	

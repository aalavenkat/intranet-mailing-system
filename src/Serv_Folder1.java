					...
					throws ServletException,IOException
{
		...
		String foldername=session.getValue("newfold").toString();
		...
		//sos.print("</form>");
		sos.println("<form><table border=2>");
		...
		sos.println("<tr bgcolor="+color+"><td><a href=Serv_Show_Folder1?foldval="+fol[j]+">"+fol[j]+"</td><td>"+n[j]+"</td><td>"+t[j]+"</td>");

...
public class Serv_Inbox1 extends HttpServlet
{
   ...
   public void service(HttpServletRequest req, HttpServletResponse res)throws ServletException,IOException
   {
      try
      {
		 ...
		 folder=session.getValue("newfold").toString();
		 ...
		 sos.println("<b><pre>                                                         <i>Folders</i></b></pre>");
		 sos.println("<div align=right><table border=1 cellpadding=4 cellspacing=5 width=96 height=111>");
         sos.println("<tr><td><a href='Serv_Show_Folder?foldname="+folder+"'>'"+folder+"'</a></td></tr></table></div>");
		 int rscount=0;
